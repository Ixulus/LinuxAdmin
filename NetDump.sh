...
mv ipdns.txt NetInfo$(date +%Y_%m_%d_%H_%M_%S).txt # Appead a timestamp to the file
mv NetInfo$(date +%Y_%m_%d_%H_%M_%S).txt /home/karnold/ServerInfo/ # Move file to new location
